...
def _extraer_traccion_electrica(
    ...
    data = {
        ...
        "Encoder_txt": _leer_regex(seccion, "Encoder_txt", linea_encoder, r"Encoder\s+(\S+)", debug),
        "Protocolo": _leer_regex(seccion, "Protocolo", linea_encoder, r"Protocolo:\s*(\S+)", debug),
